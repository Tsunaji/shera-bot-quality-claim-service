# shera-bot-quality-claim-service
...
- Navigate to `shera-bot-quality-claim-service` folder
- Select `shera-bot-quality-claim-service.bot` file
...
msbot clone services --name "shera-bot-quality-claim-service" --code-dir "." --location <azure region like eastus, westus, westus2 etc.> --sdkLanguage "Node" --folder deploymentScripts/msbotClone --verbose
```
